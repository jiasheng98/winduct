...
<head>
    ...
    <script type="text/javascript" async="" src="js/slideshow.js"></script>
    ...
    <link href="css/swiper.css" rel="stylesheet" type="text/css" media="screen">
    <link class="main-stylesheet" href="css/style.css" rel="stylesheet" type="text/css">
    <link class="main-sty`lesheet" href="css/pages-icons.css" rel="stylesheet" type="text/css">
    <style type="text/css">
        .cf-hidden {
            display: none;
        }
...
<body class="pace-dark windows desktop pace-done">
    ...
    <nav class="header bg-header transparent-dark" id="site-header" data-pages="header" data-pages-header="autoresize" data-pages-resize-class="dark">
        <div class="container relative">
            <div class="pull-left">
                <div class="header-inner">
                    <a href="index.html"><img src="images/logo_winduct.png" width="152" data-src-retina="images/logo_winduct_2x.png" class="logo" alt=""><img src="images/logo_winduct.png" width="152" data-src-retina="images/logo_winduct_2x.png" class="alt" alt=""></a>
                </div>
            </div>
            ...
            <div class="menu-content mobile-dark pull-right clearfix" data-pages-direction="slideRight" id="header">
                <div class="pull-right"><a href="#" class="padding-10 visible-xs-inline visible-sm-inline pull-right m-t-10 m-b-10 m-r-10" data-pages="header-toggle" data-pages-element="#header"><i class=" pg-close_line"></i></a></div>
            </div>
        </div>
    </nav>
    <div class="pace pace-inactive">
    ...
    <nav class="header bg-header transparent-light" data-pages="header" data-pages-header="autoresize" data-pages-resize-class="dark">
        <div class="container relative">
            ...
            <div class="pull-right">
                <div class="header-inner ">
                    <div class="visible-sm-inline visible-xs-inline menu-toggler pull-right m-b-20" data-pages="header-toggle" data-pages-element="#header" style="background-color: black">
                        <div class="one"></div>
                        <div class="two"></div>
                        <div class="three"></div>
                    </div>
            ...
            <div class="menu-content mobile-dark pull-right clearfix" data-pages-direction="slideRight" id="header">
                <div class="pull-right">
                    <a href="#" class="padding-10 visible-xs-inline visible-sm-inline pull-right m-t-10 m-b-10 m-r-10" data-pages="header-toggle" data-pages-element="#header" style="color: black;"> <i class=" pg-close_line"></i> </a>
                </div>
                <div class="header-inner">
                    <ul class="menu">
                      ...
                      <li class="classic"><a href="all_projects7.html">Project References</a></li>
    ...
    <script src="https://cdn.jotfor.ms/static/jotform.forms.js?3.3.1305" type="text/javascript"></script>
    ...
    <section class="container container-fixed-lg p-t-10 p-b-100 sm-p-b-30 sm-m-b-30">
        <div class="row" style="margin-top: 10%;">
            <div class="col-md-6">
                <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d7968.068859692406!2d101.576168!3d3.085486!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31cc4c4e0b7ee115%3A0x23ef9295c3e52d6a!2s27%2C+Jalan+Pengacara+U1%2F48%2C+Kawasan+Perindustrian+Temasya%2C+40150+Shah+Alam%2C+Selangor%2C+Malaysia!5e0!3m2!1sen!2smy!4v1499074529108" width="100%" height="300" frameborder="0" style="border:0; ;" allowfullscreen></iframe>
                <h2>Passive Fire Protection Sdn. Bhd.</h2>
                <div class="sm-p-r-0 sm-p-l-0">
                    <div class="">
                        <div class="">
                            <p><strong>Address</strong></p>
                        </div>
                        <div class="">
                            <p>No 27, Jalan Pengacara U1/48, Section U1, Temasya Industrial Park, 40150 Shah Alam, Selangor Darul Ehsan,Malaysia.</p>
                        </div>
                    </div>
                    <div class="">
                        <div class="">
                    ...
                    <div class="">
                        ...
                        <div class="">
                            <p><a href="mailto:sales@winduct.com">sales@winduct.com</a> / <a href="mailto:winduct@gmail.com">winduct@gmail.com</a></p>
                        </div>
                    </div>
                    <div class="">
                        <div class="">
                        ...
                        <div class="">
                            <p><a href="index.html">www.winduct.com</a></p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <h5>Get In Touch</h5>
                <form class="jotform-form" action="contact-form-handler.php" method="post" id="contact-form">
                    <div class=form-all>
                        <label class="form-label form-label-left form-label-auto" id="label_3" for="company_name"> Company Name* </label>
                        <div id="cid_3" class="form-input jf-required">
                            <input type="text" id="company_name" name="company_name" data-type="input-textbox" class="form-control validate[required, AlphaNumeric]" size="40" value="" data-component="textbox" required="" placeholder="Company Name" /> </div>
                        <label class="form-label form-label-left" id="label_4" for="name"> Your Name*</label>
                        <div id="cid_4" class="form-input jf-required">
                            <input type="text" id="name" name="name" data-type="input-textbox" class="form-control validate[required, Numeric]" size="40" value="" data-component="textbox" required="" placeholder="Your Name" /> </div>
                        <label class="form-label form-label-left form-label-auto" id="label_5" for="email">Your Email* </label>
                        <div id="cid_5" class="form-input jf-required">
                            <input type="email" id="email" name="email" data-type="input-textbox" class="form-control validate[required, Email]" size="40" value="" placeholder=" Your Email" data-component="textbox" required="" /> </div>
                        <label class="form-label form-label-left form-label-auto" id="label_6" for="contact">Your Contact*</label>
                        <div id="cid_6" class="form-input jf-required">
                            <input type="text" id="contact" name="contact" data-type="input-textbox" class="form-control validate[required, AlphaNumeric]" size="40" value="" data-component="textbox" required="" placeholder="Your Contact" /> </div>
                        <label class="form-label form-label-left form-label-auto" id="label_8" for="message"> Your Message* </label>
                        <div id="cid_7" class="form-input jf-required">
                            <textarea id="message" class="form-control validate[required]" name="message" cols="40" rows="6" data-component="textarea" placeholder="Please, keep your message in details and easy to understand" required style="resize: none"></textarea>
                        </div>
                        <center>
                            <div id=cid_2 class=form-input-wide>
                                <div class=form-buttons-wrapper>
                                    <input type="submit" id="submit" class="btn btn-success call-to-action-link btn-lg" value="Send"/>
                                    <!-- <button id=input_2 type=submit class="btn btn-success call-to-action-link btn-lg" data-component=button> Send </button> -->
                                </div>
                            </div>
                        </center>
                        ...
                        <input type="hidden" id="simple_spc" name="simple_spc" value="72148364955465" />
                        <script type="text/javascript">
                            document.getElementById("si" + "mple" + "_spc").value = "72148364955465-72148364955465";
                        </script> -->
                </form>
                <!-- <script type="text/javascript">
          ...
          <section class="p-b-40 p-t-40 xs-p-b-20 bg-master-darker" id ="ftr"></section>
    <script src="js/pace.min.js" type="text/javascript"></script>
    <script src="js/google.js" type="text/javascript"></script>
    <script type="text/javascript" src="js/pages.image.loader.js"></script>
